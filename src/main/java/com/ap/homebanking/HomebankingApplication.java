...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository, TransactionRepository transactionRepository,
		...
		return (args -> {
			...
			Account account1 = new Account("VIN-001", LocalDate.now(), 5000, true, AccountType.CHECKING);
			Account account2 = new Account("VIN-002", LocalDate.now().plusDays(1), 7500, true, AccountType.SAVINGS);
			Account account3 = new Account("VIN-003", LocalDate.of(2022, 1, 11), 250000, true, AccountType.SAVINGS);
			Account account4 = new Account("VIN-004", LocalDate.of(2020, 7, 20), 25000000, true, AccountType.SAVINGS);
			...
			Transaction transaction1 = new Transaction(TransactionType.CREDIT,1000,"sale_001",LocalDateTime.now(), account1.getBalance()+1000);
			Transaction transaction2 = new Transaction(TransactionType.DEBIT,-5000,"purchase_001", LocalDateTime.now(), account2.getBalance()-5000);
			Transaction transaction3 = new Transaction(TransactionType.CREDIT, 2500, "sale_002", LocalDateTime.now(), account3.getBalance()+2500);
			Transaction transaction4 = new Transaction(TransactionType.DEBIT,-3000,"purchase_002",LocalDateTime.now(), account4.getBalance()-3000);
			Transaction transaction5 = new Transaction(TransactionType.DEBIT,-2000,"purchase_003",LocalDateTime.now(), account1.getBalance()-2000);
			...
			Loan loan3 = new Loan("Auto", 300000, List.of(12, 24, 36), 15);
			...
			Card card1 = new Card((client1.getFirstName()).concat(" ").concat(client1.getLastName()), CardType.DEBIT, CardColor.GOLD, "1234-5678-9000-0000", 123, LocalDateTime.now().minusYears(2), LocalDateTime.now().minusDays(7), true);
